...
public class KamiGUI extends GUI {
    ...
    public void initializeGUI() {
        ...
        this.addMouseListener(new MouseListener() {
            ...
            @Override
            public void onMouseDown(MouseButtonEvent event) {
                List<SettingsPanel> panels = ContainerHelper.getAllChildren(SettingsPanel.class, me.zeroeightsix.kami.gui.kami.KamiGUI.this);
        ...
        information.addTickListener(() -> {
            ...
            if (ModuleManager.getModuleByName("InfoOverlay").isEnabled()) {
                information.setText("");
                information.addLine("\u00A7c\u00A7lFums \u00A74\u00A7lHack");
                information.addLine("");
                if (privateInfoNam) {
                    information.addLine("\u00A7cHello," + Command.SECTIONSIGN() + "4 " + privateDisplayN + "\u00A7c!");
                }
                if (privateInfoTps) {
                    information.addLine("\u00A7c" + Math.round(LagCompensator.INSTANCE.getTickRate()) + Command.SECTIONSIGN() + "4 tps");
                }
                if (privateInfoFps) {
                    information.addLine("\u00A7c" + Wrapper.getMinecraft().debugFPS + Command.SECTIONSIGN() + "4 fps");
                }
                if (privateInfoPin) {
                    information.addLine("\u00A7c" + privatePingValue + Command.SECTIONSIGN() + "4 ms");
                }
                if (privateInfoMem) {
                    information.addLine("\u00A7c" + (Runtime.getRuntime().freeMemory() / 1000000) + Command.SECTIONSIGN() + "4mb free");
                }
            }
            else {
                information.setText("");
...
//            information.addLine("[&3" + Sprint.getSpeed() + "km/h&r]");
        ...
        entityLabel.addTickListener(new TickListener() {
            ...
            public void onTick() {
                ...
                final Map<String, Integer> entityCounts = entityList.stream()
                        ...
                        .collect(Collectors.groupingBy(me.zeroeightsix.kami.gui.kami.KamiGUI::getEntityName,
        ...
        coordsLabel.addTickListener(new TickListener() {
            ...
            public void onTick() {
                ...
                coordsLabel.setText(String.format(" %sc%,d%sc %sc%,d%sc %sc%,d %sf | %s4%,d%s4 %s4%,d%s4 %s4%,d%s4",
                        Command.SECTIONSIGN(),
                        posX,
                        Command.SECTIONSIGN(),
                        Command.SECTIONSIGN(),
