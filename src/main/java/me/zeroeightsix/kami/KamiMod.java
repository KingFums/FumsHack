...
public class KamiMod {
    ...
    public static final String MODNAME = "Fums Hack";
    public static final String MODVER = "v1.0";

    public static final String KAMI_HIRAGANA = "\uA20E";
    public static final String KAMI_KATAKANA = "\uA20E";
    public static final String KAMI_KANJI = "\uA20E";
    public static final String KAMI_BLUE = "\u0493\u222A\u03FB\uA1D9 \u2C67\u2A5C\u1455\u2C69";
